...
class KVStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PingHost = channel.unary_unary(
                '/proto.KV/PingHost',
                request_serializer=kv__pb2.PingHostRequest.SerializeToString,
                response_deserializer=kv__pb2.PingHostResponse.FromString,
                _registered_method=True)
...
class KVServicer(object):
    ...
    def PingHost(self, request, context):
        """Plugin dials back into the host on broker_id and calls Callback.Notify().
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_KVServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PingHost': grpc.unary_unary_rpc_method_handler(
                    servicer.PingHost,
                    request_deserializer=kv__pb2.PingHostRequest.FromString,
                    response_serializer=kv__pb2.PingHostResponse.SerializeToString,
            ),
    }
...
class KV(object):
    ...
    def PingHost(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/proto.KV/PingHost',
            kv__pb2.PingHostRequest.SerializeToString,
            kv__pb2.PingHostResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
